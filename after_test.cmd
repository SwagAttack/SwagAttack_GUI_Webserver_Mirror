...
dotnet test C:\projects\swagattack-gui-webserver-mirror\GUI\UnitTests\UnitTests.csproj --no-build --no-restore --logger:Appveyor /p:CollectCoverage=true /p:CoverletOutputFormat=opencover
coveralls.net.0.412\tools\csmacnz.Coveralls.exe --opencover -i ..\GUI\UnitTests\coverage.xml

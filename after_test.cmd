...
OpenCover.4.6.519\tools\OpenCover.Console.exe -target:"dotnet.exe" -register:user -targetargs:"vstest ..\GUI\GUI_Index.unit.test\WebserverUnitTests.csproj" -filter:"+[*]* -[*.Tests]*"

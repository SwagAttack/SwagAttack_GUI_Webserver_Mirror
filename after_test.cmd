...
dotnet test C:\projects\swagattack-gui-webserver-mirror\GUI\GUICommLayerUnitTests\GUICommLayerUnitTests.csproj --no-build --no-restore --logger:Appveyor /p:CollectCoverage=true /p:CoverletOutputFormat=opencover
dotnet test C:\projects\swagattack-gui-webserver-mirror\GUI\WebserverIntegrationTests\WebserverIntegrationTests.csproj --no-build --no-restore --logger:Appveyor /p:CollectCoverage=true /p:CoverletOutputFormat=opencover

coveralls.net.0.412\tools\csmacnz.Coveralls.exe --opencover -i ..\GUI\GUICommLayerUnitTests\coverage.xml
coveralls.net.0.412\tools\csmacnz.Coveralls.exe --opencover -i ..\GUI\GUI_Index.unit.test\coverage.xml
coveralls.net.0.412\tools\csmacnz.Coveralls.exe --opencover -i ..\GUI\WebserverIntegrationTests\coverage.xml

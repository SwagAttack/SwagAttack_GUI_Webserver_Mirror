...
nuget install coveralls.net -Version 1.0.0-beta0001 -OutputDirectory tools
...
coveralls.net.1.0.0-beta0001\tools\csmacnz.Coveralls.exe --opencover -i C:\projects\swagattack-gui-webserver-mirror\GUI\GUI_Index.unit.test\coverage.xml
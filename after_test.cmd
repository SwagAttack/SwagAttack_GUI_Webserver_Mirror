...
dotnet test C:\projects\swagattack-gui-webserver-mirror\GUI\GUI_Index.unit.test\WebserverUnitTests.csproj --no-build --no-restore --logger:Appveyor /p:CollectCoverage=true /p:CoverletOutputFormat=opencover REM --test-adapter-path:.
coveralls.net.0.412\tools\csmacnz.Coveralls.exe --opencover -i coverage.xml
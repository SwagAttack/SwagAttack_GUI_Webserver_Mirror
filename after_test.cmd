...
OpenCover.4.6.519\tools\OpenCover.Console.exe -target:NUnit.ConsoleRunner.3.8.0/tools/nunit3-console.exe -register:user -targetargs:"..\GUI\GUI_Index.unit.test\bin\Debug\netcoreapp2.0\WebserverUnitTests.dll" -filter:"+[*]* -[*.Tests]*"

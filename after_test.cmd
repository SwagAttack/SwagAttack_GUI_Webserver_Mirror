...
REM coveralls.net.0.412\tools\csmacnz.Coveralls.exe --opencover -i .results.xml
dotnet test C:\projects\swagattack-gui-webserver-mirror\GUI\GUI_Index.unit.test\WebserverUnitTests.csproj --no-build --no-restore --logger:Appveyor /p:CollectCoverage=true REM --test-adapter-path:.
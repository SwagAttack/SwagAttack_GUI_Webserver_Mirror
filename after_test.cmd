...
OpenCover.4.6.519\tools\OpenCover.Console.exe -target:C:\Program Files\dotnet\dotnet.exe -register:user -targetargs:"test --no-build ..\GUI\GUI_Index.unit.test\bin\Debug\netcoreapp2.0\WebserverUnitTests.dll" -filter:"+[*]* -[*.Tests]*"
